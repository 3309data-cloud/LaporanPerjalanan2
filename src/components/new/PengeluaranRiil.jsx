...
import { laporanprint } from "../../styles/laporanprint";
...
export default function PengeluaranRiil({ row }) {
  ...
  return (
    <>
      {/* INI KUNCI NYA: Menempelkan teks CSS ke dalam HTML agar dibaca browser */}
      <style>{laporanprint}</style>
